...
public class BudgetUpdater {
	...
	private JTextField lblName2;
	private JTextField lblName3;
	private JTextField lblName4;
	...
	public void expenseChanger(String table) {
		...
		try {
			...
			//TODO Use table to in multiple ifs kind of like the code in add unis
